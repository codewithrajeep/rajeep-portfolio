export const data = {
  ...
  experience: [
    {
      ...
      points: [
        "Built W3 Worksphere — a full internal HRM platform with 18 modules including Auth, Payroll, Attendance, Leave, CRM, and more",
        "Migrated production database from Railway MySQL to Neon PostgreSQL with zero downtime",
        "Delivered full handover documentation and API docs on contract completion",
      ],
      tech: ["Node.js", "TypeScript", "PostgreSQL", "Prisma", "Express"],
    },
  ],
  ...
  projects: [
    {
      name: "Hookman",
      description: "Webhook delivery service similar to Svix/Hookdeck. Handles reliable webhook dispatch with queuing, retries, and API key auth.",
    ...
    {
      name: "Pulseboard",
      description: "Backend monitoring and analytics platform. Full CI/CD pipeline with Docker, deployed on Render with Neon PostgreSQL.",
    ...
    {
      name: "Noted",
      description: "Full-stack task and project management app with JWT auth, refresh tokens, and a clean modular architecture.",
